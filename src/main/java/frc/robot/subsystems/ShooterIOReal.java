...
public class ShooterIOReal implements ShooterIO {
    ...
    private final TalonFX flywheelA =
            new TalonFX(Constants.CAN.CTRE.shooterFlywheelA, Constants.CAN.CTRE.bus); // Kraken x60
    private final TalonFX flywheelB =
            new TalonFX(Constants.CAN.CTRE.shooterFlywheelB, Constants.CAN.CTRE.bus); // Kraken x60
    private final TalonFX uptake = new TalonFX(
            Constants.CAN.CTRE.uptake,
            Constants.CAN.CTRE.bus); // Kraken x44 // TODO: Determine if this is a TalonFX or TalonSRX
