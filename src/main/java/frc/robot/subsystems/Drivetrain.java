...
public class Drivetrain extends SubsystemBase {
    public static class State {
        ...
        public State(final SwerveModuleState[] states) {
            this.states = states;
        }
        ...
        public SwerveModuleState get(final Place place) {
            return this.states[place.index];
        }
    ...
    private static final RobotConfig PP_CONFIG = /* TODO: TUNE THESE FOR OUR ROBOT */ new RobotConfig(
            ROBOT_MASS_KG,
            ROBOT_MOI,
            new ModuleConfig(
    ...
    public Drivetrain() {
        ...
        this.est = new SwerveDrivePoseEstimator(
                this.kinematics, new Rotation2d(this.gyroInputs.yawPosition), this.modulePositions(), new Pose2d());
    ...
    public void control(ChassisSpeeds speeds) {
        ...
        // When the robot is translating while rotating, the motion is actually along an arc, but ChassisSpeeds is
        // representing linear movement.
        // So, it figures out what arc movement gets the robot to the correct spot after 1 program loop based on the
        // provided ChassisSpeeds.
    ...
    public void control(final Drivetrain.State state) {
        this.control(state.states);
    }
    ...
    public void periodic() {
        ...
        if (mt2 != null) {
            ...
            if (!doRejectUpdate) {
                ...
                est.addVisionMeasurement(mt2.pose, mt2.timestampSeconds);
            }
        }
